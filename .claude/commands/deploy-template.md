...
name: deploy
description: >
  Faz o deploy completo do projeto: verifica mudanças, cria branch,
...
- **Git**: `C:\Users\SEU_USUARIO_WINDOWS\AppData\Local\Programs\Git\bin\git.exe`
- **Caminho do projeto**: `C:\caminho\completo\ate\seu\projeto`
...
> **Como preencher:** abra o terminal e rode `git remote -v` para ver o repo, e `echo %USERPROFILE%` para ver o caminho do usuário Windows.
...
```powershell
$git = "C:\Users\SEU_USUARIO_WINDOWS\AppData\Local\Programs\Git\bin\git.exe"
Set-Location "C:\caminho\completo\ate\seu\projeto"
& $git status
& $git diff --stat
```
...
$resp = Invoke-RestMethod -Uri "https://api.github.com/repos/SEU_USUARIO_GITHUB/SEU_REPOSITORIO/pulls" -Method Post -Headers $headers -Body $body -ContentType "application/json"
...
$resp = Invoke-RestMethod -Uri "https://api.github.com/repos/SEU_USUARIO_GITHUB/SEU_REPOSITORIO/pulls/NUMERO/merge" -Method Put -Headers $headers -Body $mergeBody -ContentType "application/json"
